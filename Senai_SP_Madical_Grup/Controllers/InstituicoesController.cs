...
using Senai_SP_Madical_Grup.Repositories;
using System;
    ...
    public class InstituicoesController : ControllerBase
    {
        ...
        public IActionResult Atualizar(int id, Instituicao attClinica)
        {
            try
            {
                ...
                if (attClinica.Cnpj == null || attClinica.Endereco == null || attClinica.NomeInstuicao == null || attClinica.RazaoSocial == null || attClinica.Cnpj.Length != 14)
                {
                    return BadRequest(new
                    {
